...
public abstract class NetworkParameters implements Serializable {
     ...
     */
    public static int PROTOCOL_VERSION = 70002;
    ...
    protected static final int TARGET_TIMESPAN = 6 * 8 * 60;  // 2 weeks per difficulty cycle, on average.
    protected static final int TARGET_SPACING = 2 * 60;  // 10 minutes per block.
     ...
     */
    private BigInteger MAX_MONEY = new BigInteger("640000000", 10).multiply(COIN);
